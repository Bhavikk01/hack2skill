...
class _$_UserModel implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(uid: $uid, username: $username, email: $email, photoId: $photoId, phoneNumber: $phoneNumber, posts: $posts, connections: $connections)';
  }
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      required final List<String> posts,
      required final List<String> connections}) = _$_UserModel;
